package com.cryption.app.ui.widget.holder;
...
import static com.cryption.app.ui.widget.holder.TransactionHolder.DEFAULT_ADDRESS_ADDITIONAL;
...
public class TransferHolder extends BinderViewHolder<TokenTransferData> implements View.OnClickListener
{
                          ...
                          AssetDefinitionService svs)
    {
        ...
        findViewById(R.id.layout_background).setBackgroundResource(R.drawable.cry_bg_overlay);
    }
