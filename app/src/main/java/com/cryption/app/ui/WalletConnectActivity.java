...
import com.cryption.app.entity.walletconnect.WCRequest;
import com.cryption.app.repository.SignRecord;
import com.cryption.app.ui.widget.entity.ActionSheetCallback;
import com.cryption.app.viewmodel.WalletConnectViewModel;
import com.cryption.app.viewmodel.WalletConnectViewModelFactory;
import com.cryption.app.walletconnect.WCClient;
import com.cryption.app.walletconnect.WCSession;
import com.cryption.app.walletconnect.entity.WCEthereumSignMessage;
import com.cryption.app.walletconnect.entity.WCEthereumTransaction;
import com.cryption.app.walletconnect.entity.WCPeerMeta;
...
import static com.cryption.app.C.DEFAULT_GAS_LIMIT_FOR_NONFUNGIBLE_TOKENS;
    ...
    private ActionSheetDialog generateTransactionRequest(Web3Transaction w3Tx, int chainId)
    {
        ...
        try
        {
                    ...
                    || (!w3Tx.recipient.equals(Address.EMPTY) && (w3Tx.payload != null || w3Tx.value != null))) // Raw or Function TX
            {
                ...
                viewModel.calculateGasEstimate(viewModel.getWallet(), com.cryption.token.tools.Numeric.hexStringToByteArray(w3Tx.payload),
