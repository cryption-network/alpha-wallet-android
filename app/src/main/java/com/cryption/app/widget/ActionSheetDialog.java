...
import com.cryption.app.entity.ActionSheetInterface;
...
import com.cryption.app.entity.TransactionInput;
...
import com.cryption.app.ui.TransactionSuccessActivity;
...
public class ActionSheetDialog extends BottomSheetDialog implements StandardFunctionInterface, ActionSheetInterface
{
    ...
    public void lockDragging(boolean lock)
    {
        ...
        if (lock)
        {
            ...
            if (bottomSheet != null) {
                bottomSheet.setBackgroundColor(getContext().getColor(R.color.colorPrimary));
